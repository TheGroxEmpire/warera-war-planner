...
def attacks_possible(hp, hun, armor, dodge, food, pill_mode=False):
...
def compute_totals(skill_levels, gear_idx, ammo_idx, food_idx, rank_bonus=1.45, pill_mode=False, pill_price=0.0, tables=None):
